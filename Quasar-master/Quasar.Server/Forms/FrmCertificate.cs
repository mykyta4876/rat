...
namespace Quasar.Server.Forms
{
    public partial class FrmCertificate : Form
    {
        ...
        {
            SetCertificate(CertificateHelper.CreateCertificateAuthority("Flood Server CA", 4096));
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(this,
                    "There was an error saving the certificate, please make sure you have write access to the Flood directory.",
                    "Save error", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
