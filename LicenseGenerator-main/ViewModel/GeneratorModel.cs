...
namespace LicenseGenerator.ViewModel
{
    public class GeneratorModel : ViewModel
    {
        ...
        public void GenerateLicense()
        {
            ...
            // The key consists of authorization information length + authorization information + authorization information signature, and is presented in the form of Base64
            // Use 2 bytes to store the information length
