...
ProcessHollowing::ProcessHollowing()
{
    ...
    if (Tools::FileExists(targetPath))
    {
        ...
        {
#ifndef LOG_OFF
            std::cout << "ProcessHollowing::ProcessHollowing: CreateFileA failed\n\n";
#endif // LOG_OFF
            return;
        }
        ...
        {
#ifndef LOG_OFF
            std::cout << "ProcessHollowing::ProcessHollowing: GetFileSize failed\n\n";
#endif // LOG_OFF
            return;
        }
        ...
        {
#ifndef LOG_OFF
            std::cout << "ProcessHollowing::ProcessHollowing: HeapAlloc failed\n\n";
#endif // LOG_OFF
            return;
        }
        ...
        {
#ifndef LOG_OFF
            std::cout << "ProcessHollowing::ProcessHollowing: ReadFile failed\n\n";
#endif // LOG_OFF
            return;
        }
        ...
        {
#ifndef LOG_OFF
            std::cout << "ProcessHollowing::ProcessHollowing: StartPH started\n\n";
#endif // LOG_OFF
            exit(1);
        }
        else
        {
#ifndef LOG_OFF
            std::cout << "ProcessHollowing::ProcessHollowing: StartPH failed\n\n";
#endif // LOG_OFF
        }
    }
    else
